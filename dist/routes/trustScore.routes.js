...
router.get("/:id/score", validateId, controllerWrapper(TrustScoreController.getPublicScore));
export default router;
// Route owner montée séparément dans app.ts sous /api/owner
export const ownerScoreRouter = Router();
ownerScoreRouter.get("/score", authenticateOwner, controllerWrapper(TrustScoreController.getOwnScore));
//# sourceMappingURL=trustScore.routes.js.map