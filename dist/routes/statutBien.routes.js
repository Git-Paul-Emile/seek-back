...
import { createStatutBienSchema, updateStatutBienSchema, } from "../validators/statutBien.validator.js";
const router = Router();
...
router.post("/", authenticate, validate(createStatutBienSchema), controllerWrapper(StatutBienController.create));
/** PUT /api/statuts-bien/:id — admin */
router.put("/:id", authenticate, validate(updateStatutBienSchema), controllerWrapper(StatutBienController.update));
/** DELETE /api/statuts-bien/:id — admin */
router.delete("/:id", authenticate, controllerWrapper(StatutBienController.remove));
export default router;
//# sourceMappingURL=statutBien.routes.js.map