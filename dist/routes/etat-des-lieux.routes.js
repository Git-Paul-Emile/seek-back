...
// ========================
router.post("/upload", authenticateOwner, uploadImageMiddleware, EtatDesLieuxController.uploadImage);
router.post("/", authenticateOwner, EtatDesLieuxController.create);
router.put("/:id", authenticateOwner, EtatDesLieuxController.update);
router.post("/:id/submit", authenticateOwner, EtatDesLieuxController.submit);
router.delete("/:id", authenticateOwner, EtatDesLieuxController.deleteBrouillon);
router.post("/:id/resoudre-contestation", authenticateOwner, EtatDesLieuxController.resoudreContestations);
// ========================
...
// ========================
router.post("/locataire/upload", authenticateLocataire, uploadImageMiddleware, EtatDesLieuxController.uploadImage);
router.post("/locataire/:id/contester", authenticateLocataire, EtatDesLieuxController.contester);
router.post("/locataire/:id/validate", authenticateLocataire, EtatDesLieuxController.validate);
export default router;
//# sourceMappingURL=etat-des-lieux.routes.js.map