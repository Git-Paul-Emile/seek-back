...
import { createTypeTransactionSchema, updateTypeTransactionSchema, } from "../validators/typeTransaction.validator.js";
const router = Router();
...
router.post("/", authenticate, validate(createTypeTransactionSchema), controllerWrapper(TypeTransactionController.create));
/** PUT /api/types-transaction/:id — admin */
router.put("/:id", authenticate, validate(updateTypeTransactionSchema), controllerWrapper(TypeTransactionController.update));
