...
router.get("/verifications/count", authenticate, controllerWrapper(async (req, res) => {
...
router.get("/verifications", authenticate, controllerWrapper(async (req, res) => {
    const verifications = await verificationService.getPendingVerifications();
    res.json({ status: "success", data: verifications });
}));
// GET /api/admin/verifications/:id - Détails d'une demande
router.get("/verifications/:id", authenticate, controllerWrapper(async (req, res) => {
...
router.post("/verifications/:id/approve", authenticate, controllerWrapper(async (req, res) => {
    const id = getIdParam(req.params);
...
router.post("/verifications/:id/reject", authenticate, controllerWrapper(async (req, res) => {
    const id = getIdParam(req.params);
    const adminId = req.admin.id;
...
//# sourceMappingURL=adminVerification.routes.js.map