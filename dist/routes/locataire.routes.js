...
router.get("/:id/lien", validateId, controllerWrapper(LocataireController.getLienActivation));
/** GET /api/owner/locataires/:id */
router.get("/:id", validateId, controllerWrapper(LocataireController.getLocataireById));
