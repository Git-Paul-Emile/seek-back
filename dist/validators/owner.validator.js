...
export const registerOwnerSchema = z.object({
    ...
    telephone: z
        ...
        .regex(/^[+]?[\d\s\-()\d]{7,}$/, "Format invalide - ex : 77 000 00 00 ou +221 77 000 00 00"),
    email: z
        .string()
        .refine((v) => v === "" || z.string().email().safeParse(v).success, "Format email invalide - ex : prenom@email.com")
        .optional(),
    password: z
...
export const loginOwnerSchema = z.object({
    identifiant: z
        .string({ error: "L'identifiant est requis" })
