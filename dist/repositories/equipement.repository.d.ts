...
export declare const findByNomAndCategorie: (nom: string, categorieId: string) => import("../generated/prisma/models.js").Prisma__EquipementClient<({
    categorie: {
        id: string;
        nom: string;
        slug: string;
...
export declare const update: (id: string, data: Partial<{
    ...
    categorieId: string;
    actif: boolean;
}>) => import("../generated/prisma/models.js").Prisma__EquipementClient<{
    categorie: {
        id: string;
        nom: string;
        slug: string;
...
export declare const remove: (id: string) => import("../generated/prisma/models.js").Prisma__EquipementClient<{
    id: string;
    createdAt: Date;
    updatedAt: Date;
    nom: string;
...
//# sourceMappingURL=equipement.repository.d.ts.map