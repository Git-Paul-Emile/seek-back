...
export const getAllPaysWithVilles = asyncHandler(async (req, res) => {
...
export const getAllPays = asyncHandler(async (req, res) => {
    const pays = await prisma.pays.findMany({
        orderBy: { nom: 'asc' }
    });
    res.status(200).json({
...
export const getPaysById = asyncHandler(async (req, res) => {
...
export const getVillesByPays = asyncHandler(async (req, res) => {
...
export const getAllVilles = asyncHandler(async (req, res) => {
...
export const getVillesSenegal = asyncHandler(async (req, res) => {
    const villes = await prisma.ville.findMany({
        where: {
            pays: { code: 'SN' }
        },
...
export const createPays = asyncHandler(async (req, res) => {
...
export const createVille = asyncHandler(async (req, res) => {
...
export const deletePays = asyncHandler(async (req, res) => {
    const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
    const pays = await prisma.pays.findUnique({
        where: { id }
    });
...
// Supprimer une ville
export const deleteVille = asyncHandler(async (req, res) => {
    const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
...
//# sourceMappingURL=villeController.js.map