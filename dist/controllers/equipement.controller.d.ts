...
export declare const getAllAdmin: (_req: Request, res: Response) => Promise<void>;
export declare const createMany: (req: Request, res: Response) => Promise<void>;
...
//# sourceMappingURL=equipement.controller.d.ts.map