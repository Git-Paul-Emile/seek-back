...
export const uploadImageMiddleware = (req, res, next) => {
    multerInstance(req, res, (err) => {
        ...
        if (err instanceof MulterError && err.code === "LIMIT_FILE_SIZE") {
            return next(new AppError("Image trop volumineuse. Taille maximale autorisée : 5 Mo", StatusCodes.BAD_REQUEST));
        }
        ...
        return next(new AppError("Erreur lors du traitement du fichier", StatusCodes.INTERNAL_SERVER_ERROR));
    });
};
