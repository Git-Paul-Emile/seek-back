 ...
 */
export const sendPasswordResetEmail = async (email, code, nomComplet) => {
    try {
        const mailOptions = {
      ...
      `,
        ...
        throw new AppError("Erreur lors de l'envoi de l'email", StatusCodes.INTERNAL_SERVER_ERROR);
    }
};
/**
 * Envoyer un email de confirmation d'inscription
 */
export const sendWelcomeEmail = async (email, nomComplet) => {
    try {
        const mailOptions = {
            from: process.env.EMAIL_FROM || "Seek <noreply@seek.sn>",
            to: email,
