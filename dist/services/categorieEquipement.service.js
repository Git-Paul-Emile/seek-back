...
export const remove = async (id) => {
    ...
    if (count > 0) {
        throw new AppError(`Impossible de supprimer : ${count} équipement${count > 1 ? "s" : ""} utilise${count > 1 ? "nt" : ""} cette catégorie.`, StatusCodes.CONFLICT);
    }
    await Repo.remove(id);
};
//# sourceMappingURL=categorieEquipement.service.js.map