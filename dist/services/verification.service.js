...
export const verificationService = {
     ...
     */
    async getStatus(proprietaireId) {
     ...
     */
    async submitVerification(proprietaireId, data) {
        const proprietaire = await prisma.proprietaire.findUnique({
            where: { id: proprietaireId },
        });
        if (!proprietaire) {
     ...
     */
    async approve(proprietaireId, adminId) {
        const proprietaire = await prisma.proprietaire.findUnique({
            where: { id: proprietaireId },
     ...
     */
    async reject(proprietaireId, adminId, motif) {
        const proprietaire = await prisma.proprietaire.findUnique({
            where: { id: proprietaireId },
            include: { verification: true },
        });
