...
// @ts-nocheck 
/*
 * This file exports the `LocataireRefreshToken` model and its related types.
 *
...
export type GetLocataireRefreshTokenAggregateType<T extends LocataireRefreshTokenAggregateArgs> = {
      [P in keyof T & keyof AggregateLocataireRefreshToken]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateLocataireRefreshToken[P]>
    : Prisma.GetScalarType<T[P], AggregateLocataireRefreshToken[P]>
}
...
type GetLocataireRefreshTokenGroupByPayload<T extends LocataireRefreshTokenGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<LocataireRefreshTokenGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof LocataireRefreshTokenGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], LocataireRefreshTokenGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], LocataireRefreshTokenGroupByOutputType[P]>
      }
    >
  >
...
export type LocataireRefreshTokenCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<LocataireRefreshTokenFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface LocataireRefreshTokenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['LocataireRefreshToken'], meta: { name: 'LocataireRefreshToken' } }
  /**
   ...
   * })
  **/
  count<T extends LocataireRefreshTokenCountArgs>(
    args?: Prisma.Subset<T, LocataireRefreshTokenCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], LocataireRefreshTokenCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends LocataireRefreshTokenGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, LocataireRefreshTokenGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetLocataireRefreshTokenGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
