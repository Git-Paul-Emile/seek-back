...
// @ts-nocheck 
/*
 * This file exports the `BailLocation` model and its related types.
 *
...
export type GetBailLocationAggregateType<T extends BailLocationAggregateArgs> = {
      [P in keyof T & keyof AggregateBailLocation]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBailLocation[P]>
    : Prisma.GetScalarType<T[P], AggregateBailLocation[P]>
}
...
type GetBailLocationGroupByPayload<T extends BailLocationGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BailLocationGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BailLocationGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BailLocationGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BailLocationGroupByOutputType[P]>
      }
    >
  >
...
export type BailLocationCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BailLocationFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BailLocationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['BailLocation'], meta: { name: 'BailLocation' } }
  /**
   ...
   * })
  **/
  count<T extends BailLocationCountArgs>(
    args?: Prisma.Subset<T, BailLocationCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BailLocationCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends BailLocationGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, BailLocationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBailLocationGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
