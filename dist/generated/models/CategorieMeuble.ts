...
// @ts-nocheck 
/*
 * This file exports the `CategorieMeuble` model and its related types.
 *
...
export type GetCategorieMeubleAggregateType<T extends CategorieMeubleAggregateArgs> = {
      [P in keyof T & keyof AggregateCategorieMeuble]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCategorieMeuble[P]>
    : Prisma.GetScalarType<T[P], AggregateCategorieMeuble[P]>
}
...
type GetCategorieMeubleGroupByPayload<T extends CategorieMeubleGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CategorieMeubleGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CategorieMeubleGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CategorieMeubleGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CategorieMeubleGroupByOutputType[P]>
      }
    >
  >
...
export type CategorieMeubleCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CategorieMeubleFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CategorieMeubleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CategorieMeuble'], meta: { name: 'CategorieMeuble' } }
  /**
   ...
   * })
  **/
  count<T extends CategorieMeubleCountArgs>(
    args?: Prisma.Subset<T, CategorieMeubleCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CategorieMeubleCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CategorieMeubleGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CategorieMeubleGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCategorieMeubleGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
