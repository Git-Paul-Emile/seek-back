...
// @ts-nocheck 
/*
 * This file exports the `PromotionHistory` model and its related types.
 *
...
export type GetPromotionHistoryAggregateType<T extends PromotionHistoryAggregateArgs> = {
      [P in keyof T & keyof AggregatePromotionHistory]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePromotionHistory[P]>
    : Prisma.GetScalarType<T[P], AggregatePromotionHistory[P]>
}
...
type GetPromotionHistoryGroupByPayload<T extends PromotionHistoryGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PromotionHistoryGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PromotionHistoryGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PromotionHistoryGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PromotionHistoryGroupByOutputType[P]>
      }
    >
  >
...
export type PromotionHistoryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PromotionHistoryFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PromotionHistoryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PromotionHistory'], meta: { name: 'PromotionHistory' } }
  /**
   ...
   * })
  **/
  count<T extends PromotionHistoryCountArgs>(
    args?: Prisma.Subset<T, PromotionHistoryCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PromotionHistoryCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PromotionHistoryGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PromotionHistoryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPromotionHistoryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
