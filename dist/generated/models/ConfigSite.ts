...
// @ts-nocheck 
/*
 * This file exports the `ConfigSite` model and its related types.
 *
...
export type GetConfigSiteAggregateType<T extends ConfigSiteAggregateArgs> = {
      [P in keyof T & keyof AggregateConfigSite]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateConfigSite[P]>
    : Prisma.GetScalarType<T[P], AggregateConfigSite[P]>
}
...
type GetConfigSiteGroupByPayload<T extends ConfigSiteGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ConfigSiteGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ConfigSiteGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ConfigSiteGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ConfigSiteGroupByOutputType[P]>
      }
    >
  >
...
export type ConfigSiteCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ConfigSiteFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ConfigSiteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ConfigSite'], meta: { name: 'ConfigSite' } }
  /**
   ...
   * })
  **/
  count<T extends ConfigSiteCountArgs>(
    args?: Prisma.Subset<T, ConfigSiteCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ConfigSiteCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ConfigSiteGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ConfigSiteGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetConfigSiteGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
