...
// @ts-nocheck 
/*
 * This file exports the `StatutBien` model and its related types.
 *
...
export type GetStatutBienAggregateType<T extends StatutBienAggregateArgs> = {
      [P in keyof T & keyof AggregateStatutBien]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateStatutBien[P]>
    : Prisma.GetScalarType<T[P], AggregateStatutBien[P]>
}
...
type GetStatutBienGroupByPayload<T extends StatutBienGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<StatutBienGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof StatutBienGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], StatutBienGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], StatutBienGroupByOutputType[P]>
      }
    >
  >
...
export type StatutBienCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<StatutBienFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface StatutBienDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['StatutBien'], meta: { name: 'StatutBien' } }
  /**
   ...
   * })
  **/
  count<T extends StatutBienCountArgs>(
    args?: Prisma.Subset<T, StatutBienCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], StatutBienCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends StatutBienGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, StatutBienGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetStatutBienGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
