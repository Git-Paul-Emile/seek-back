...
// @ts-nocheck 
/*
 * This file exports the `MessageInterne` model and its related types.
 *
...
export type GetMessageInterneAggregateType<T extends MessageInterneAggregateArgs> = {
      [P in keyof T & keyof AggregateMessageInterne]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMessageInterne[P]>
    : Prisma.GetScalarType<T[P], AggregateMessageInterne[P]>
}
...
type GetMessageInterneGroupByPayload<T extends MessageInterneGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MessageInterneGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MessageInterneGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MessageInterneGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MessageInterneGroupByOutputType[P]>
      }
    >
  >
...
export type MessageInterneCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MessageInterneFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MessageInterneDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MessageInterne'], meta: { name: 'MessageInterne' } }
  /**
   ...
   * })
  **/
  count<T extends MessageInterneCountArgs>(
    args?: Prisma.Subset<T, MessageInterneCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MessageInterneCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MessageInterneGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MessageInterneGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMessageInterneGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
