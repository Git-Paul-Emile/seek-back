...
// @ts-nocheck 
/*
 * This file exports the `ModeleContrat` model and its related types.
 *
...
export type GetModeleContratAggregateType<T extends ModeleContratAggregateArgs> = {
      [P in keyof T & keyof AggregateModeleContrat]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateModeleContrat[P]>
    : Prisma.GetScalarType<T[P], AggregateModeleContrat[P]>
}
...
type GetModeleContratGroupByPayload<T extends ModeleContratGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ModeleContratGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ModeleContratGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ModeleContratGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ModeleContratGroupByOutputType[P]>
      }
    >
  >
...
export type ModeleContratCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ModeleContratFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ModeleContratDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ModeleContrat'], meta: { name: 'ModeleContrat' } }
  /**
   ...
   * })
  **/
  count<T extends ModeleContratCountArgs>(
    args?: Prisma.Subset<T, ModeleContratCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ModeleContratCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ModeleContratGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ModeleContratGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetModeleContratGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
