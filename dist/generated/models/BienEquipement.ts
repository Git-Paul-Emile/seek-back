...
// @ts-nocheck 
/*
 * This file exports the `BienEquipement` model and its related types.
 *
...
export type GetBienEquipementAggregateType<T extends BienEquipementAggregateArgs> = {
      [P in keyof T & keyof AggregateBienEquipement]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBienEquipement[P]>
    : Prisma.GetScalarType<T[P], AggregateBienEquipement[P]>
}
...
type GetBienEquipementGroupByPayload<T extends BienEquipementGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BienEquipementGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BienEquipementGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BienEquipementGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BienEquipementGroupByOutputType[P]>
      }
    >
  >
...
export type BienEquipementCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BienEquipementFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BienEquipementDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['BienEquipement'], meta: { name: 'BienEquipement' } }
  /**
   ...
   * })
  **/
  count<T extends BienEquipementCountArgs>(
    args?: Prisma.Subset<T, BienEquipementCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BienEquipementCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends BienEquipementGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, BienEquipementGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBienEquipementGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
