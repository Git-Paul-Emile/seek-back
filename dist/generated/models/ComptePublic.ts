...
// @ts-nocheck 
/*
 * This file exports the `ComptePublic` model and its related types.
 *
...
export type GetComptePublicAggregateType<T extends ComptePublicAggregateArgs> = {
      [P in keyof T & keyof AggregateComptePublic]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateComptePublic[P]>
    : Prisma.GetScalarType<T[P], AggregateComptePublic[P]>
}
...
type GetComptePublicGroupByPayload<T extends ComptePublicGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ComptePublicGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ComptePublicGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ComptePublicGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ComptePublicGroupByOutputType[P]>
      }
    >
  >
...
export type ComptePublicCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ComptePublicFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ComptePublicDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ComptePublic'], meta: { name: 'ComptePublic' } }
  /**
   ...
   * })
  **/
  count<T extends ComptePublicCountArgs>(
    args?: Prisma.Subset<T, ComptePublicCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ComptePublicCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ComptePublicGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ComptePublicGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetComptePublicGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
