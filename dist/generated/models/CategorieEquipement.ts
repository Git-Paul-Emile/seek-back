...
// @ts-nocheck 
/*
 * This file exports the `CategorieEquipement` model and its related types.
 *
...
export type GetCategorieEquipementAggregateType<T extends CategorieEquipementAggregateArgs> = {
      [P in keyof T & keyof AggregateCategorieEquipement]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCategorieEquipement[P]>
    : Prisma.GetScalarType<T[P], AggregateCategorieEquipement[P]>
}
...
type GetCategorieEquipementGroupByPayload<T extends CategorieEquipementGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CategorieEquipementGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CategorieEquipementGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CategorieEquipementGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CategorieEquipementGroupByOutputType[P]>
      }
    >
  >
...
export type CategorieEquipementCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CategorieEquipementFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CategorieEquipementDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CategorieEquipement'], meta: { name: 'CategorieEquipement' } }
  /**
   ...
   * })
  **/
  count<T extends CategorieEquipementCountArgs>(
    args?: Prisma.Subset<T, CategorieEquipementCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CategorieEquipementCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CategorieEquipementGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CategorieEquipementGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCategorieEquipementGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
