...
// @ts-nocheck 
/*
 * This file exports the `BienMeuble` model and its related types.
 *
...
export type GetBienMeubleAggregateType<T extends BienMeubleAggregateArgs> = {
      [P in keyof T & keyof AggregateBienMeuble]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBienMeuble[P]>
    : Prisma.GetScalarType<T[P], AggregateBienMeuble[P]>
}
...
type GetBienMeubleGroupByPayload<T extends BienMeubleGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BienMeubleGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BienMeubleGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BienMeubleGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BienMeubleGroupByOutputType[P]>
      }
    >
  >
...
export type BienMeubleCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BienMeubleFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BienMeubleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['BienMeuble'], meta: { name: 'BienMeuble' } }
  /**
   ...
   * })
  **/
  count<T extends BienMeubleCountArgs>(
    args?: Prisma.Subset<T, BienMeubleCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BienMeubleCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends BienMeubleGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, BienMeubleGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBienMeubleGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
