...
// @ts-nocheck 
/*
 * This file exports the `TypeTransaction` model and its related types.
 *
...
export type GetTypeTransactionAggregateType<T extends TypeTransactionAggregateArgs> = {
      [P in keyof T & keyof AggregateTypeTransaction]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTypeTransaction[P]>
    : Prisma.GetScalarType<T[P], AggregateTypeTransaction[P]>
}
...
type GetTypeTransactionGroupByPayload<T extends TypeTransactionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TypeTransactionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TypeTransactionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TypeTransactionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TypeTransactionGroupByOutputType[P]>
      }
    >
  >
...
export type TypeTransactionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TypeTransactionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TypeTransactionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TypeTransaction'], meta: { name: 'TypeTransaction' } }
  /**
   ...
   * })
  **/
  count<T extends TypeTransactionCountArgs>(
    args?: Prisma.Subset<T, TypeTransactionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TypeTransactionCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends TypeTransactionGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, TypeTransactionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTypeTransactionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
