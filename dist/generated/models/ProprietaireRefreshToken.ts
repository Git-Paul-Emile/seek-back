...
// @ts-nocheck 
/*
 * This file exports the `ProprietaireRefreshToken` model and its related types.
 *
...
export type GetProprietaireRefreshTokenAggregateType<T extends ProprietaireRefreshTokenAggregateArgs> = {
      [P in keyof T & keyof AggregateProprietaireRefreshToken]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateProprietaireRefreshToken[P]>
    : Prisma.GetScalarType<T[P], AggregateProprietaireRefreshToken[P]>
}
...
type GetProprietaireRefreshTokenGroupByPayload<T extends ProprietaireRefreshTokenGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ProprietaireRefreshTokenGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ProprietaireRefreshTokenGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ProprietaireRefreshTokenGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ProprietaireRefreshTokenGroupByOutputType[P]>
      }
    >
  >
...
export type ProprietaireRefreshTokenCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ProprietaireRefreshTokenFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ProprietaireRefreshTokenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ProprietaireRefreshToken'], meta: { name: 'ProprietaireRefreshToken' } }
  /**
   ...
   * })
  **/
  count<T extends ProprietaireRefreshTokenCountArgs>(
    args?: Prisma.Subset<T, ProprietaireRefreshTokenCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ProprietaireRefreshTokenCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ProprietaireRefreshTokenGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ProprietaireRefreshTokenGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetProprietaireRefreshTokenGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
