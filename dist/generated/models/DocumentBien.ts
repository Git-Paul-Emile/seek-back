...
// @ts-nocheck 
/*
 * This file exports the `DocumentBien` model and its related types.
 *
...
export type GetDocumentBienAggregateType<T extends DocumentBienAggregateArgs> = {
      [P in keyof T & keyof AggregateDocumentBien]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDocumentBien[P]>
    : Prisma.GetScalarType<T[P], AggregateDocumentBien[P]>
}
...
type GetDocumentBienGroupByPayload<T extends DocumentBienGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DocumentBienGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DocumentBienGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DocumentBienGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DocumentBienGroupByOutputType[P]>
      }
    >
  >
...
export type DocumentBienCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<DocumentBienFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DocumentBienDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['DocumentBien'], meta: { name: 'DocumentBien' } }
  /**
   ...
   * })
  **/
  count<T extends DocumentBienCountArgs>(
    args?: Prisma.Subset<T, DocumentBienCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DocumentBienCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends DocumentBienGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, DocumentBienGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDocumentBienGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
