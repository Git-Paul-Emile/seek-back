...
// @ts-nocheck 
/*
 * This file exports the `DepotCaution` model and its related types.
 *
...
export type GetDepotCautionAggregateType<T extends DepotCautionAggregateArgs> = {
      [P in keyof T & keyof AggregateDepotCaution]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDepotCaution[P]>
    : Prisma.GetScalarType<T[P], AggregateDepotCaution[P]>
}
...
type GetDepotCautionGroupByPayload<T extends DepotCautionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DepotCautionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DepotCautionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DepotCautionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DepotCautionGroupByOutputType[P]>
      }
    >
  >
...
export type DepotCautionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<DepotCautionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DepotCautionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['DepotCaution'], meta: { name: 'DepotCaution' } }
  /**
   ...
   * })
  **/
  count<T extends DepotCautionCountArgs>(
    args?: Prisma.Subset<T, DepotCautionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DepotCautionCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends DepotCautionGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, DepotCautionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDepotCautionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
