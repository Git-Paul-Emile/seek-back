...
// @ts-nocheck 
/*
 * This file exports the `Temoignage` model and its related types.
 *
...
export type GetTemoignageAggregateType<T extends TemoignageAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTemoignage[P]>
    : Prisma.GetScalarType<T[P], AggregateTemoignage[P]>
}
...
type GetTemoignageGroupByPayload<T extends TemoignageGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TemoignageGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TemoignageGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TemoignageGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TemoignageGroupByOutputType[P]>
      }
    >
  >
...
export type TemoignageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TemoignageFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TemoignageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['Temoignage'], meta: { name: 'Temoignage' } }
  /**
  ...
  **/
  count<T extends TemoignageCountArgs>(
    args?: Prisma.Subset<T, TemoignageCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TemoignageCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, TemoignageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTemoignageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
