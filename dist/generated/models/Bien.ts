...
// @ts-nocheck 
/*
 * This file exports the `Bien` model and its related types.
 *
...
export type GetBienAggregateType<T extends BienAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBien[P]>
    : Prisma.GetScalarType<T[P], AggregateBien[P]>
}
...
type GetBienGroupByPayload<T extends BienGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BienGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BienGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BienGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BienGroupByOutputType[P]>
      }
    >
  >
...
export type BienCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface BienDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends BienCountArgs>(
    args?: Prisma.Subset<T, BienCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BienCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, BienGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBienGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
