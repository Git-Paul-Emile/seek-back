...
// @ts-nocheck 
/*
 * This file exports the `ElementEtatDesLieux` model and its related types.
 *
...
export type GetElementEtatDesLieuxAggregateType<T extends ElementEtatDesLieuxAggregateArgs> = {
      [P in keyof T & keyof AggregateElementEtatDesLieux]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateElementEtatDesLieux[P]>
    : Prisma.GetScalarType<T[P], AggregateElementEtatDesLieux[P]>
}
...
type GetElementEtatDesLieuxGroupByPayload<T extends ElementEtatDesLieuxGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ElementEtatDesLieuxGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ElementEtatDesLieuxGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ElementEtatDesLieuxGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ElementEtatDesLieuxGroupByOutputType[P]>
      }
    >
  >
...
export type ElementEtatDesLieuxCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ElementEtatDesLieuxFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ElementEtatDesLieuxDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ElementEtatDesLieux'], meta: { name: 'ElementEtatDesLieux' } }
  /**
   ...
   * })
  **/
  count<T extends ElementEtatDesLieuxCountArgs>(
    args?: Prisma.Subset<T, ElementEtatDesLieuxCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ElementEtatDesLieuxCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ElementEtatDesLieuxGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ElementEtatDesLieuxGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetElementEtatDesLieuxGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
