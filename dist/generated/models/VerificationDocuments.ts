...
// @ts-nocheck 
/*
 * This file exports the `VerificationDocuments` model and its related types.
 *
...
export type GetVerificationDocumentsAggregateType<T extends VerificationDocumentsAggregateArgs> = {
      [P in keyof T & keyof AggregateVerificationDocuments]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateVerificationDocuments[P]>
    : Prisma.GetScalarType<T[P], AggregateVerificationDocuments[P]>
}
...
type GetVerificationDocumentsGroupByPayload<T extends VerificationDocumentsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<VerificationDocumentsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof VerificationDocumentsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], VerificationDocumentsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], VerificationDocumentsGroupByOutputType[P]>
      }
    >
  >
...
export type VerificationDocumentsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<VerificationDocumentsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface VerificationDocumentsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['VerificationDocuments'], meta: { name: 'VerificationDocuments' } }
  /**
   ...
   * })
  **/
  count<T extends VerificationDocumentsCountArgs>(
    args?: Prisma.Subset<T, VerificationDocumentsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], VerificationDocumentsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends VerificationDocumentsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, VerificationDocumentsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetVerificationDocumentsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
