...
// @ts-nocheck 
/*
 * This file exports the `TypeLogement` model and its related types.
 *
...
export type GetTypeLogementAggregateType<T extends TypeLogementAggregateArgs> = {
      [P in keyof T & keyof AggregateTypeLogement]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTypeLogement[P]>
    : Prisma.GetScalarType<T[P], AggregateTypeLogement[P]>
}
...
type GetTypeLogementGroupByPayload<T extends TypeLogementGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TypeLogementGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TypeLogementGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TypeLogementGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TypeLogementGroupByOutputType[P]>
      }
    >
  >
...
export type TypeLogementCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TypeLogementFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TypeLogementDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TypeLogement'], meta: { name: 'TypeLogement' } }
  /**
   ...
   * })
  **/
  count<T extends TypeLogementCountArgs>(
    args?: Prisma.Subset<T, TypeLogementCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TypeLogementCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends TypeLogementGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, TypeLogementGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTypeLogementGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
