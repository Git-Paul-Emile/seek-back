...
// @ts-nocheck 
/*
 * This file exports the `EtatDesLieux` model and its related types.
 *
...
export type GetEtatDesLieuxAggregateType<T extends EtatDesLieuxAggregateArgs> = {
      [P in keyof T & keyof AggregateEtatDesLieux]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateEtatDesLieux[P]>
    : Prisma.GetScalarType<T[P], AggregateEtatDesLieux[P]>
}
...
type GetEtatDesLieuxGroupByPayload<T extends EtatDesLieuxGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<EtatDesLieuxGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof EtatDesLieuxGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], EtatDesLieuxGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], EtatDesLieuxGroupByOutputType[P]>
      }
    >
  >
...
export type EtatDesLieuxCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<EtatDesLieuxFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface EtatDesLieuxDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['EtatDesLieux'], meta: { name: 'EtatDesLieux' } }
  /**
   ...
   * })
  **/
  count<T extends EtatDesLieuxCountArgs>(
    args?: Prisma.Subset<T, EtatDesLieuxCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], EtatDesLieuxCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends EtatDesLieuxGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, EtatDesLieuxGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEtatDesLieuxGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
