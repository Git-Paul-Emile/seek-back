...
// @ts-nocheck 
/*
 * This file exports the `ConfigMonetisation` model and its related types.
 *
...
export type GetConfigMonetisationAggregateType<T extends ConfigMonetisationAggregateArgs> = {
      [P in keyof T & keyof AggregateConfigMonetisation]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateConfigMonetisation[P]>
    : Prisma.GetScalarType<T[P], AggregateConfigMonetisation[P]>
}
...
type GetConfigMonetisationGroupByPayload<T extends ConfigMonetisationGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ConfigMonetisationGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ConfigMonetisationGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ConfigMonetisationGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ConfigMonetisationGroupByOutputType[P]>
      }
    >
  >
...
export type ConfigMonetisationCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ConfigMonetisationFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ConfigMonetisationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ConfigMonetisation'], meta: { name: 'ConfigMonetisation' } }
  /**
   ...
   * })
  **/
  count<T extends ConfigMonetisationCountArgs>(
    args?: Prisma.Subset<T, ConfigMonetisationCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ConfigMonetisationCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ConfigMonetisationGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ConfigMonetisationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetConfigMonetisationGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
