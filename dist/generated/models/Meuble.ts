...
// @ts-nocheck 
/*
 * This file exports the `Meuble` model and its related types.
 *
...
export type GetMeubleAggregateType<T extends MeubleAggregateArgs> = {
      [P in keyof T & keyof AggregateMeuble]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMeuble[P]>
    : Prisma.GetScalarType<T[P], AggregateMeuble[P]>
}
...
type GetMeubleGroupByPayload<T extends MeubleGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MeubleGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MeubleGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MeubleGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MeubleGroupByOutputType[P]>
      }
    >
  >
...
export type MeubleCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MeubleFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MeubleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['Meuble'], meta: { name: 'Meuble' } }
  /**
   ...
   * })
  **/
  count<T extends MeubleCountArgs>(
    args?: Prisma.Subset<T, MeubleCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MeubleCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, MeubleGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMeubleGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
