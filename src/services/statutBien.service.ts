...
export const getAll = (): Promise<StatutBien[]> => Repo.findAll();

export const getAllAdmin = (): Promise<StatutBien[]> => Repo.findAllAdmin();

export const getById = (id: string): Promise<StatutBien | null> => Repo.findById(id);
...
export const create = async (data: {
  ...
  if (existing) {
    throw new AppError(
      `Un statut avec le nom "${data.nom}" existe déjà.`,
